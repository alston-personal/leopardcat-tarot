...
if src.count(anchor) != 1:
    raise SystemExit(f'expected one share generator anchor, found {src.count(anchor)}')

helper = r'''function isIOSShareRuntime() {
